...
# Task parameters
DATA_DIR = '/home/zzq/Desktop/Piper_ws/data'
SIM_DATA_DIR = '/home/zzq/Datesets/aloha'
PIPER_TASK_CONFIGS ={

    'pick_charge_to_qrcode':{
        'dataset_dir': DATA_DIR+'/pick_charge_to_qrcode',
        'num_episodes': 20,
        'episode_len': 450,
        'camera_names': ['cam_front', 'cam_wrist'],
    },
    'pick_charge_to_box': {
        'dataset_dir': DATA_DIR+'/pick_charge_to_box',
        'num_episodes': 30,
        'episode_len': 450,
        'camera_names': ['cam_front', 'cam_wrist'],
    },
    'follow_box': {
        'dataset_dir': DATA_DIR+'/follow_box',
        'num_episodes': 10,
        'episode_len':450,
        'camera_names': ['cam_front', 'cam_wrist'],
    },
    'pick_hxy_to_box':{
        'dataset_dir': DATA_DIR + '/pick_hxy_to_box',
        'num_episodes': 10,
        'episode_len': 400,
        'camera_names': ['cam_front', 'cam_wrist'],
    }
